            ...
            <div class="card-box">
                ...
                <div class="mb-3 mt-4">
                    <div class="float-right d-none d-xl-block">
                        <img src="{{asset('backend/assets/images/cards/visa.png')}}" alt="user-card" height="28" />
                        <img src="{{asset('backend/assets/images/cards/master.png')}}" alt="user-card" height="28" />
                        <img src="{{asset('backend/assets/images/cards/american-express.png')}}" alt="user-card" height="28" />
                    </div>
            ...
            <div class="card-box">
                ...
                <div class="table-responsive">
                    <table class="table table-centered table-hover mb-0" id="datatable">
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('backend/assets/images/users/avatar-2.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                <span class="ml-2">Imelda J. Stanberry</span>
                            </td>
                            <td>
                                <img src="{{asset('backend/assets/images/cards/visa.png')}}" alt="user-card" height="24" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('backend/assets/images/users/avatar-3.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                <span class="ml-2">Francisca S. Lobb</span>
                            </td>
                            <td>
                                <img src="{{asset('backend/assets/images/cards/master.png')}}" alt="user-card" height="24" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('backend/assets/images/users/avatar-1.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                <span class="ml-2">James A. Wert</span>
                            </td>
                            <td>
                                <img src="{{asset('backend/assets/images/cards/amazon.png')}}" alt="user-card" height="24" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('backend/assets/images/users/avatar-4.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                <span class="ml-2">Dolores J. Pooley</span>
                            </td>
                            <td>
                                <img src="{{asset('backend/assets/images/cards/american-express.png')}}" alt="user-card" height="24" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('backend/assets/images/users/avatar-5.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                <span class="ml-2">Karen I. McCluskey</span>
                            </td>
                            <td>
                                <img src="{{asset('backend/assets/images/cards/discover.png')}}" alt="user-card" height="24" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('backend/assets/images/users/avatar-6.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('backend/assets/images/users/avatar-7.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('backend/assets/images/users/avatar-8.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('backend/assets/images/users/avatar-9.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('backend/assets/images/users/avatar-10.jpg')}}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
